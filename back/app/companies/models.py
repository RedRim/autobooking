...
from sqlalchemy import Boolean, DateTime, ForeignKey, Integer, Numeric, String, Text, Time, UniqueConstraint, func
...
class Company(Base):
    ...
    Атрибуты:
        ...
        category        — категория, например «Барбершоп», «Стоматология», «Фитнес».
